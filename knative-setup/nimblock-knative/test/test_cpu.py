import threading
from input_data.lenet_het import *
import time
import subprocess


endpoint = "\"http://lenet.default.127.0.0.1.sslip.io\""
lenet_endpoint = "\"http://lenet.default.127.0.0.1.sslip.io\""
alexnet_endpoint = "\"http://alexnet.default.127.0.0.1.sslip.io\""
ic_endpoint = "\"http://ic.default.127.0.0.1.sslip.io\""
of_endpoint = "\"http://of.default.127.0.0.1.sslip.io\""
tdr_endpoint = "\"http://tdr.default.127.0.0.1.sslip.io\""

error_log_file = "log/log.txt"
log_file_base = "output_data/lenet_cpu.txt"
